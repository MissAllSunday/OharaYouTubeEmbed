...
'<iframe frameborder="0" src="//player.vimeo.com/video/'+match[1]+'?autoplay=0" data-vimeo-id="'+d+'" allowfullscreen class="oharaEmbedIframe" style="width: 420px; height: 315px;"></iframe>':d}}));(function(a){a(function(){var b=new _oh;a("input[name=preview], input[name=post]").on("click",function(){b.refresh()})})})(jQuery);
