...
_oh.prototype.main=function(){_ohMain=this;$.each(_ohSites,function(a,b){$("."+b.identifier).each(function(a,c){c.domElement=$(this);c=$.extend(c,c.domElement.data("ohara_"+b.identifier));c.embedUrl=b.embedUrl.replace("{video_id}",c.video_id);c.requestUrl=b.requestUrl.replace("{video_id}",c.video_id);"function"==typeof b.getData?b.getData(_ohMain,c):_ohMain.getData(c);"function"==typeof b.createVideo?b.createVideo(_ohMain,c):(c.domElement.append($("<div/>",{"class":"oharaEmbed_play"})),$(c.domElement).on("click",
function(){$(this).html($this.getIframe(c));_ohMain.responsive()}))})});_ohMain.responsive()};_oh.prototype.getData=function(a){$.getJSON("https://noembed.com/embed",{format:"json",url:a.requestUrl},function(b){title=$("<div/>",{"class":"oharaEmbed_title"}).html(b.title);a.domElement.css({"background-image":"url("+b.thumbnail_url+")","background-size":"cover"});a.domElement.append(title)})};
