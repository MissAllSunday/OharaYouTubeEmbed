...
b=$("<iframe/>",{frameborder:"0",src:b,width:a.imgWidth,height:a.imgHeight,allowfullscreen:"allowfullscreen"});a.css({"background-image":"none"}).append(b);a.children(".youtube_play").css({height:"0"})})});b.responsive()};
