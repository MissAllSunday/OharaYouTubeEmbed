...
var _oh=function(){this.masterDiv=$(".oharaEmbed");this.videoFrame=$(".oharaEmbed > iframe");this.basedElement=this.masterDiv.parent();this.youtube=$(".youtube");this.defaultWidth="undefined"!==typeof _ohWidth?_ohWidth:480;this.defaultHeight="undefined"!==typeof _ohHeight?_ohHeight:270;this.aspectRatio=this.defaultHeight/this.defaultWidth;this.main();this.responsive()};
...
src:a,width:d,height:c});$(this).css({"background-image":"none"}).append(a);$(this).children(".youtube_play").css({height:"0"})})})};
_oh.prototype.responsive=function(){$this=this;$(window).resize(function(){var b=$this.basedElement.width(),a=b*$this.aspectRatio<=$this.defaultHeight?b*$this.aspectRatio:$this.defaultHeight,c=b<=$this.defaultWidth;$this.masterDiv.width(c?b:$this.defaultWidth).height(c?a:$this.defaultHeight);$this.videoFrame.each(function(){$(this).width(c?b:$this.defaultWidth).height(c?a:$this.defaultHeight)})}).resize()};
